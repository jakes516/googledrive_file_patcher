...
and keeping file versions updated. The *.sh* files included are intended as clickable menu items in the Unity game editor. The code uses Python 3.7 (Pycharm IDE) with re, requests, os, yaml, pathlib, json, zipfile, and OAuth2Service modules installed.
